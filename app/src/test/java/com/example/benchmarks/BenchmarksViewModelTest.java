...
public class BenchmarksViewModelTest {
    ...
    final static int COLLECTION_SIZE = 10;

    BenchmarksViewModel viewModel;
    Observer<List<BenchmarkItem>> mockItemsLiveData;
    Observer<Boolean> mockCalculationStartLiveData;
    ...
    public void testOnButtonToggle() {
        ...
        verifyNoInteractions(mockItemsLiveData);
    }
