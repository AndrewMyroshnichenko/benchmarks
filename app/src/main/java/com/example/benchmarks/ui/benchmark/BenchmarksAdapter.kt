...
class BenchmarksAdapter : ListAdapter<BenchmarkItem, BenchmarksAdapter.BenchmarksViewHolder>(DIFF_CALLBACK) {
    ...
    class BenchmarksViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: BenchmarkItem){
            ...
            textView.text = res.getString(R.string.whole_item_phrase,
